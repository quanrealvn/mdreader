...
internal static unsafe partial class NativeMethods
{
    ...
    /// (and therefore WM_SIZE, WM_SETFOCUS and the post-DPI-change notification) is ours. The class deliberately has no
    /// background brush: until the controller paints, the window shows what Avalonia drew underneath it, which is the
    /// document background, so nothing flashes white (§10).
    /// </summary>

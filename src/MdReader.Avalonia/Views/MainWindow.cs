...
namespace MdReader.Avalonia.Views;
...
internal sealed class MainWindow : Window
{
    ...
    private void OnColorValuesChanged(object? sender, PlatformColorValues values)
    {
        ...
        {
            WebViewSecurity.ApplyTheme(controller, theme, _log);
        }
    ...
    private async Task RunKeyProbeAsync()
    {
        ...
        {
            _context.Exit(SpikeExitCodes.Success);
        }
    }
    ...
    private void OnWebViewInitializationFailed(object? sender, Exception exception)
    {
        ...
        SetStatus(message);
        _context.Exit(SpikeExitCodes.WebViewUnavailable);
    }
    ...
    private async Task CaptureAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            _context.Exit(SpikeExitCodes.CaptureFailed);
        }
    }

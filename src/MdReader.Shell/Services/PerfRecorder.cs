...
public sealed class PerfRecorder : IPerfRecorder
{
    ...
    public void WriteReportIfPending() => WriteReport();
...
public static class StartupClock
{
    ...
    public static DateTime MainEnteredUtc { get; private set; }

    public static TimeSpan ElapsedSinceMain => Stopwatch.GetElapsedTime(s_mainEnteredTimestamp);

    public static void MarkMainEntered()
    {
